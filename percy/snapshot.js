...
PercyScript.run(async (page, percySnapshot) => {
    // await page.goto('http://localhost:63874/?path=/story/navigation--simple');
    ...
    await page.goto('http://localhost:63874/iframe.html?id=navigation--navigation-simple&knob-Brand%20style=nca');
    await percySnapshot('Navigation - Simple - nca');

    await page.goto('http://localhost:63874/iframe.html?id=navigation--navigation-simple&knob-Brand%20style=mhr');
    await percySnapshot('Navigation - Simple - mhr');

    await page.goto('http://localhost:63874/iframe.html?id=navigation--navigation-simple&knob-Brand%20style=bodyandsoul');
    await percySnapshot('Navigation - Simple - bodyandsoul');

    await page.goto('http://localhost:63874/iframe.html?id=navigation--navigation-simple&knob-Brand%20style=whimn');
    await percySnapshot('Navigation - Simple - whimn');

    await page.goto('http://localhost:63874/iframe.html?id=navigation--navigation-simple&knob-Brand%20style=kidspot');
    await percySnapshot('Navigation - Simple - kidspot');
});